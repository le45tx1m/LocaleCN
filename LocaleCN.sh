...
if [ "${release}" == "centos" ]; then
	...
	cd /etc
	rm -rf locale.conf
	wget https://ghproxy.com/https://raw.githubusercontent.com/FunctionClub/LocaleCN/master/locale.conf > /dev/null 2>&1
	...
	cd /etc/
	wget https://ghproxy.com/https://raw.githubusercontent.com/FunctionClub/LocaleCN/master/locale.gen > /dev/null 2>&1
	locale-gen
	cd /etc/default/
	wget https://ghproxy.com/https://raw.githubusercontent.com/FunctionClub/LocaleCN/master/locale.conf > /dev/null 2>&1
	cp locale.conf locale
